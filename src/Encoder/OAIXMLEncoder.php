...
/*
 * This file is COPIED FROM part of the Symfony package.
 *
 ...
 */
namespace Drupal\rest_oai\Encoder;
...
// class OaiXmlEncoder extends XmlEncoder {
...
//     $base_encoder->setRootNodeName('OAI-PMH');
//     return $base_encoder;
//   }
// }
 ...
 */
class OaiXmlEncoder extends SerializerAwareEncoder implements EncoderInterface, DecoderInterface, NormalizationAwareInterface
{
    const FORMAT = 'oaixml';
    ...
    private $format;
    private $context;
    private $rootNodeName = 'OAI-PMH';
    private $loadOptions;

    /**
     * Construct new OaiXmlEncoder and allow to change the root node element name.
     *
     * @param string   $rootNodeName
     * @param int|null $loadOptions  A bit field of LIBXML_* constants
     */
    public function __construct($rootNodeName = 'OAI-PMH', $loadOptions = null)
    {
     ...
     * {@inheritdoc}
     */
    public function encode($data, $format, array $context = array('xml_format_output' => 'true', 'xml_version' => '1.0', 'xml_encoding' => 'UTF-8', 'xml_standalone' => 'yes'))
    {
